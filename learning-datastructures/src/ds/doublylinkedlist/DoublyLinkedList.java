...
public class DoublyLinkedList {
	...
	public Node deleteFirst() {
		...
		first = first.next; // we are assigning the reference of the node following the old first node to the first filed in the linked list object
	...
	public Node deleteLast() {
		...
		if(first.next == null) { // there is only one item in the list
			...
			last.previous.next = null; // the last node's previous node's next filed will point to null
		}
